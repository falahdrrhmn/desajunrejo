						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<h4 class="fw-bold text-uppercase"> tampil belum acc request surat pembuatan ktp</h4>
									</div>
								</div>
									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_skp natural join data_user where status=1";
    ...
    if(isset($_POST['acc'])){
        if(isset($_POST['check']))
        {
                    foreach ($_POST['check'] as $value){
                        // echo $value;
                        $ubah = "UPDATE data_request_skp set status =2 where id_request_skp = $value"; 
