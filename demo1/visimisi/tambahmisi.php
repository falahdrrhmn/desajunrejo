            ...
            <form method="POST">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">FORM TAMBAH misi</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label>misi</label>
                                    <input type="text" name="isi" class="form-control" placeholder="misi..">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-action">
                        ...
                        <a href="?halaman=misi" class="btn btn-default btn-sm">Batal</a>
                    </div>
                </div>
            </form>
        </div>
...
if (isset($_POST['simpan'])) {
    ...
    $sql = "INSERT INTO misi (isi) VALUES ('$isi')";
