            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">Misi Desa</h4>
                        <a href="?halaman=tambahmisi" class="btn btn-primary btn-round ml-auto">
...
<?php
if (isset($_GET['id'])) {
    $sql_hapus = "DELETE FROM misi WHERE id='" . $_GET['id'] . "'";
