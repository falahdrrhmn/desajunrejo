						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<h4 class="fw-bold text-uppercase">TAMPIL ACC REQUEST SURAT pembuatan KTP</h4>
									</div>
								</div>
								<div class="card-body">
								<form method="POST">
									<div class="table-responsive">
										<table id="add3" class="display table table-striped table-hover" >
											...
											<tbody>
                                                <?php
												$i=1;
                                                    $sql = "SELECT * FROM data_request_skp natural join data_user where status=0";
    ...
    if(isset($_POST['acc'])){
        if(isset($_POST['check']))
        {
                    foreach ($_POST['check'] as $value){
                        // echo $value;
                        $ubah = "UPDATE data_request_skp set status =1 where id_request_skp = $value"; 
